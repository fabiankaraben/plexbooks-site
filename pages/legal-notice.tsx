    ...
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            En el momento en que accedas a este sitio web https://plexbooks.com, asumes la condición
            de usuario, por lo que el contenido de este Aviso Legal te afecta directamente. Por eso,
            es importante que lo leas para disipar cualquier duda que puedas tener y tener
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>El responsable y titular de este sitio web es PLEXBOOKS</p>
          <p>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            Como responsable del sitio web, PLEXBOOKS podrá interrumpir el servicio de la página que
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            Como titular de este sitio web, PLEXBOOKS no garantiza que los contenidos sean precisos
            o libres de error o que el libre uso de los mismos por parte de los usuarios no infrinja
          ...
          <p>
            ...
            finalidad y el medio utilizado para ello, sin autorización previa de PLEXBOOKS.
          </p>
        </div>
      </div>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            lo que PLEXBOOKS no podrá ser considerado responsable de los contenidos de estos sitios
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            En ejercicio de su derecho como titular de esta web, te informamos de que PLEXBOOKS no
            se hace responsable en ningún caso de lo siguiente:
          </p>
          <p>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>Toda esta información la podrás encontrar en nuestra POLITICA DE PRIVACIDAD.</p>
        </div>
      </div>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="mt-7 pt-4 pb-6 md:space-y-5">
