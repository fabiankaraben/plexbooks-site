  ...
  return (
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            https://plexbooks.com, estás en el lugar indicado. A continuación, vamos a explicarte
            qué son exactamente las cookies; qué tipo de cookies utilizamos y para qué; y cómo
            puedes ejercer tu derecho para configurar tu navegador y desestimar el uso de cualquiera
            de ellas.
          </p>
          <p>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            Una cookie es un fichero que se descarga en tu ordenador al acceder a determinadas
            páginas web o blogs
          </p>
          <p>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            desarrollar su actividad, este sitio web https://plexbooks.com, utiliza cookies propias
            y de terceros.
          </p>
        </div>
      </div>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            <strong>Cookies de terceros</strong>: Esta web https://plexbooks.com puede utilizar
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            <a href="https://support.apple.com/es-es/HT201265" target="_blank" rel="noreferrer">
              Apple Safari
            </a>
          </p>
          <p>
            Si tienes cualquier duda sobre esta Política de Cookies, puedes contactar con nosotros
            enviándonos un mail a hi.plexbooks@gmail.com.
          </p>
        </div>
      </div>
    </>
