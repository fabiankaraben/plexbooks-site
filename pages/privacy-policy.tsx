  ...
  return (
    <>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            corresponden como usuario de esta web https://plexbooks.com y eso está muy bien. Nuestro
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          ...
          <p>
            ...
            comunicaciones realizadas por parte de PLEXBOOKS, como titular de la web.
          </p>
          ...
          <p>
            ...
            de controles, ni recomendación por nuestra parte, por lo que en ningún caso PLEXBOOKS
            será considerada responsable de los contenidos de estos sitios web, de las
            responsabilidades derivadas de su uso en todos los ámbitos, ni por las medidas que se
            adopten relativas a la privacidad del usuario, tratamiento de sus datos de carácter
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            remitas a PLEXBOOKS, exonerándonos de cualquier responsabilidad al respecto.
          </p>
          <p>
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            ...
            electrónico a hi.plexbooks@gmail.com y adjuntándonos una fotocopia de tu documento de
          ...
          <p>
            ...
            que hayas recibido o enviándonos un correo a hi.plexbooks@gmail.com.
          </p>
        </div>
      </div>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="prose max-w-none pt-8 pb-8 dark:prose-dark xl:col-span-2">
          <p>
            Como titular de la web, PLEXBOOKS ha adoptado todas las medidas técnicas y de
            organización necesaria para garantizar la seguridad e integridad de los datos de
