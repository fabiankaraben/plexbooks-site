...
import type { JavaScriptBook } from 'contentlayer/generated'

interface Props {
  posts: CoreContent<JavaScriptBook>[]
  title: string
  initialDisplayPosts?: CoreContent<JavaScriptBook>[]
  pagination?: ComponentProps<typeof Pagination>
}

export default function JavaScriptBookListLayout({
  posts,
  title,
  initialDisplayPosts = [],
  pagination,
