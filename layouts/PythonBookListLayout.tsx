...
import type { PythonBook } from 'contentlayer/generated'

interface Props {
  posts: CoreContent<PythonBook>[]
  title: string
  initialDisplayPosts?: CoreContent<PythonBook>[]
  pagination?: ComponentProps<typeof Pagination>
}

export default function PythonBookListLayout({
  posts,
  title,
  initialDisplayPosts = [],
  pagination,
