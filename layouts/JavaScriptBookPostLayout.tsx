...
const editUrl = (slug) => `${siteMetadata.siteRepo}/blob/master/data/javascript-book/${slug}`
// const discussUrl = (slug) =>
//   `https://mobile.twitter.com/search?q=${encodeURIComponent(
//     `${siteMetadata.siteUrl}/javascript/${slug}`
//   )}`
...
export default function JavaScriptBookPostLayout({
  content,
  authorDetails,
  next,
  prev,
  ...
  return (
    <SectionContainer>
      <BlogSEO
        url={`${siteMetadata.siteUrl}/javascript/${slug}`}
                    ...
                    {prev && (
                      <div>
                        ...
                        <div className="text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400">
                          <Link href={`/javascript/${prev.slug}`}>{prev.title}</Link>
                        </div>
                      </div>
                    )}
                    {next && (
                      <div>
                        ...
                        <div className="text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400">
                          <Link href={`/javascript/${next.slug}`}>{next.title}</Link>
                        </div>
                      </div>
                    )}
                  </div>
